...
<p>Our Terms and Conditions were last updated on 09/12/2022.</p>
<p>Please read these terms and conditions carefully before using Our Service.</p>
<p class="term-title">Interpretation and Definitions</p>
<p class="term-title">Interpretation</p>
<p>The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.</p>
<p class="term-title">Definitions</p>
<p>For the purposes of these Terms and Conditions:</p>

<p class="term-title">"Service"refers to the Website.</p>


<p class="term-title">Acknowledgment</p>
...
<p class="term-title">User Accounts</p>
...
<p class="term-title">Content</p>
<p class="term-title">Your Right to Post Content</p>
...
<p class="term-title">Content Restrictions</p>
...
<p class="term-title">Content Backups</p>
...
<p> class="term-title"Copyright Policy</p>
<p class="term-title">Intellectual Property Infringement</p>
...
<p>If You are a copyright owner, or authorized on behalf of one, and You believe that the copyrighted work has been copied in a way that constitutes copyright infringement that is taking place through the Service, You must submit Your notice in writing to the attention of our copyright agent via email (mat@taskforce.com) and include in Your notice a detailed description of the alleged infringement.</p>
...
<p class="term-title">DMCA Notice and DMCA Procedure for Copyright Infringement Claims</p>
<p>You may submit a notification pursuant to the Digital Millennium Copyright Act (DMCA) by providing our Copyright Agent with the following information in writing (see 17 U.S.C 512(c)(3) for further detail):</p>

<p>You can contact our copyright agent via email ((mat@taskforce.com). Upon receipt of a notification, the Company will take whatever action, in its sole discretion, it deems appropriate, including removal of the challenged content from the Service.</p>
<p class="term-title">Intellectual Property</p>
...
<p class="term-title">Your Feedback to Us</p>
...
<p class="term-title">Links to Other Websites</p>
...
<p class="term-title">Termination</p>
<p>We may terminate or suspend Your Account immediately, without prior notice or liability, for any reason whatsoever, including without limitation if You breach these Terms and Conditions.</p>
<p>Upon termination, Your right to use the Service will cease immediately. If You wish to terminate Your Account, You may simply discontinue using the Service.</p>
<p class="term-title">Limitation of Liability</p>
...
<p class="term-title">"AS IS" and "AS AVAILABLE" Disclaimer</p>
...
<p class="term-title">Governing Law</p>
<p>The laws of the Country, excluding its conflicts of law rules, shall govern this Terms and Your use of the Service. Your use of the Application may also be subject to other local, state, national, or international laws.</p>
<p class="term-title">Disputes Resolution</p>
<p>If You have any concern or dispute about the Service, You agree to first try to resolve the dispute informally by contacting the Company.</p>
<p class="term-title">For European Union (EU) Users</p>
<p>If You are a European Union consumer, you will benefit from any mandatory provisions of the law of the country in which you are resident in.</p>
<p class="term-title">United States Legal</p>
<p>You represent and warrant that (i) You are not located in a country that is subject to the United States government embargo, or that has been designated by the United States government as a "terrorist supporting" country, and (ii) You are not listed on any United States government list of prohibited or restricted parties.</p>
<p class="term-title">Severability and Waiver</p>
<p class="term-title">Severability</p>
<p>If any provision of these Terms is held to be unenforceable or invalid, such provision will be changed and interpreted to accomplish the objectives of such provision to the greatest extent possible under applicable law and the remaining provisions will continue in full force and effect.</p>
<p class="term-title">Waiver</p>
...
<p class="term-title">Translation Interpretation</p>
...
<p class="term-title">Changes to These Terms and Conditions</p>
<p>We reserve the right, at Our sole discretion, to modify or replace these Terms at any time. If a revision is material We will make reasonable efforts to provide at least 30 days' notice prior to any new terms taking effect. What constitutes a material change will be determined at Our sole discretion.</p>
<p>By continuing to access or use Our Service after those revisions become effective, You agree to be bound by the revised terms. If You do not agree to the new terms, in whole or in part, please stop using the website and the Service.</p>
<p class="term-title">Contact Us</p>
<p>If you have any questions about these Terms and Conditions, You can contact us:</p>
<ul>
<li>By visiting this page on our website: [wwww.taskforce.com]</li>
<li>By sending us an email: [contact@taskforce.com]</li>
</ul>
<p><li> us an email: contact@taskforce.com]</li>
</p>
